                ...
                <div class="card bordered shadow-lg rounded-lg h-full">
                    <div class="card-body flex flex-col justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            <ParameterInfo label="Duration" value={formatDuration(Number(props.parameters.duration))}
                            ...
                            <ParameterInfo label="Participants" value={Object.keys(props.participants).length}
